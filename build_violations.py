...
persons = [
    ("Jeanne Grealish (EST)", RED_BG, RED_TXT, [
        ...
        ("G-03", "Foundation dismissal + refusal to clarify — Called MTNA Foundation newsletter 'Boring and irrelevant to most of us' to VP; did not respond when VP asked for clarification; pattern of attack without engagement"),
