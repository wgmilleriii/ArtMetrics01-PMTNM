...
rows = [
    ...
    ("G-03", "Oct 28, 2023", "Unilateral Conference Decision", "Governance + Conflict of Interest",
     ...
     "Documented via email + board minutes record (absence of decision) — Pattern consistent with unilateral leadership style"),
]
