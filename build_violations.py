...
rows = [
    ...
    ("L-08", "Nov 8, 2024; Nov 7, 2025", "Undisclosed Voting Conflict / Proxy Voting", "Governance + Conflict of Interest",
     ...
     "Board minutes verified — undisclosed conflict documented across two consecutive board meeting cycles"),
]
...
persons = [
    ...
    ("Marcus York (Board Member / NMSM Employee)", PURPLE_BG, PURPLE_TXT, [
        ("L-08", "Voted on financial matters (Nov 2024) while employed by Larry Blind; served on Blind-chaired Nominating Committee (Nov 2024–2025) — no disclosure of conflict; proxy voting concern due to Blind's employment authority over York"),
    ]),
