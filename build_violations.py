...
rows = [
    ...
    ("F-08", "Apr 25, 2025", "Financial Irregularity", "Governance + Ethics",
     "MEDIUM", "Jeanne Grealish",
     "Basic fiduciary duty; Accurate financial reporting",
     "At the Spring 2025 Board Meeting, Grealish stated that board member Teri Reck 'hadn't contributed.' This characterization of a fellow board member's financial contributions was made in a board meeting — potentially inaccurate and defamatory.",
     "Spring 2025 Board Meeting transcript/notes",
     "If inaccurate, this is a misrepresentation to the board about a member's standing. Potentially used to marginalize dissenting board members.",
     "To be verified from transcript"),
    ...
    ("L-01", "Oct 4, 2023", "Conflict of Interest", "Ethics",
     "CRITICAL", "Larry Blind",
     "MTNA Code of Ethics §3 (conflicts of interest); Nonprofit governance — board member conflicts; Robert's Rules — impartiality",
     "Larry Blind sent the Teacher of the Year voting solicitation from his BUSINESS email (lblind@nmschoolofmusic.com) on behalf of PMTNM. The winning nominee, Tatiana, is employed by Larry's school (tatiana@nmschoolofmusic.com). Larry controls Tatiana's employment and used his position as PMTNM Past President to direct votes toward his own employee.",
     "Oct 4, 2023 email from lblind@nmschoolofmusic.com soliciting TOTY votes (forwarded to Chip by Haewon Yang Sep 28, 2024); Tatiana's email address tatiana@nmschoolofmusic.com; Haewon thread 'FTC guidelines for MTNA and PMTNM' Sep 27-28, 2024",
     "Classic conflict of interest: supervisor voting-in a subordinate for a professional honor. Conducted via employer's email systems, suggesting NMSM resources used for PMTNM business.",
     "Documented — Email evidence preserved"),
    ...
    ("L-04", "Nov 5-6, 2025", "Conflict of Interest / Bias", "Ethics + Procedural",
     "CRITICAL", "Larry Blind",
     "Robert's Rules of Order — Parliamentarian must be impartial; Due process rights of meeting participants",
     "Larry Blind sent a hostile email to Chip on Nov 5-6, 2025 — the night before the board meeting — calling Chip's communication 'offensive, disrespectful, and does not deserve a response.' Larry then served as Parliamentarian at the Nov 7 meeting. The minutes attribute a parliamentary 'time call' to him that does not appear in the recording.",
     "Nov 5-6 email (Larry → Chip, CC Sharon, Jeanne, Laura); Nov 7 Board Meeting Audio Recording; INTERNAL_Minutes Review; Proposed Corrections to Minutes",
     "Parliamentarian's demonstrated bias toward the VP directly undermines procedural fairness of the meeting. The fabricated 'time call' in the minutes may have been used to cut off Chip's presentation.",
     "Audio-verified — Strong procedural violation"),
    ...
    ("L-05", "Oct 2023", "TOTY Manipulation", "Ethics + Governance",
     "CRITICAL", "Larry Blind; Tatiana Vetrinskaya (NMSM)",
     "MTNA Code of Ethics §3 (conflicts of interest); Nonprofit election integrity; Robert's Rules on impartiality",
    ...
    ("F-12", "Tax Year 2018 (filed ~2019); Tax Year 2023 (filed Dec 18, 2024)", "Regulatory / Sole Control", "Legal + Governance",
     "CRITICAL", "Jeanne Grealish",
    ...
    ("G-02", "Nov 7, 2025 (pre-meeting emails + meeting)", "Anonymous Voting Suppressed + No Confidence Motion Defeated", "Governance + Ethics",
     ...
     "Email-verified pre-meeting + Audio-verified in-meeting — anonymous voting deliberately bypassed"),
...
persons = [
    ("Jeanne Grealish (EST)", RED_BG, RED_TXT, [
        ("F-01", "Financial records refusal — VP refused access to records (Mar 2025)"),
        ...
        ("F-12", "NM AG registration (2018 + 2023): sole responsible party for all 5 financial functions BOTH years; PMTNM address = personal home both years; 'no solicitation' false both years; decade-long pattern confirmed — same false statement in all 10 years of filings (2014-2024)"),
        ...
        ("G-02", "Nov 7, 2025: vote of no confidence motion made formally; Larry controlled the second process; Sharon adjourned immediately after motion died; Grealish (subject of motion) had direct conflict of interest"),
...
email_rows = [
    ...
    ("Oct 31, 2025", "Jeanne Grealish", "Board", "Budget Committee REMINDER", "F-02", "Chip asks formal budget questions — most ignored. Larry witnesses."),
